1) Interested people land on README
...
[There should be a standardized TOC/Navigation element on *each* page.]

2) then if they are interested they go to goals-and-rules
they learn more there

3) if they decided to participate, they land on git-concepts to get an idea of what git is

4) then they go to setup and see only the information that is needed to setup stuff.  I.e. information
...
5) then they learn how to use git in "everyday" tasks.

6) Then the actual workflow is described - both git stuff (how to commit) and how to organize the work
...
7) Finally, a short description on how to pull and make pull requests.
